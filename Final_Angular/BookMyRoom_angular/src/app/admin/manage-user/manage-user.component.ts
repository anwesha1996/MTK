...
import { MatSort,MatPaginator, MatTableDataSource, MAT_DIALOG_DATA, MatDialogRef, MatDialog } from '@angular/material';
...
export class ManageUserComponent implements OnInit {
  ...
  rewards:number;
   ...
   //dataSource:any;
    receiveUser(){
      this.hotelService.fetchUser().subscribe((data:any)=>{
       this.dataSource = new MatTableDataSource<UserManage[]>(data);
     })
