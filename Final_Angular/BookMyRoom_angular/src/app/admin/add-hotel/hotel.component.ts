...
export class HotelComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder,public dialog: MatDialog,private hotelService:UserService,public auth:ConfirmserviceService, public route:Router) {
          ...
          if(data)
            {
              ...
              this.singleAcCount=0;
              this.singleNonAcCount=0;
            }
          });
        }
  }
